...
# huggingface_1.py
# ==========================================================
# A CLI helper around 🤗 Transformers pipelines / tokenizers /
# models.  It now supports:
#   • dynamic “from transformers import <ClassName>”
#   • pipeline-based or tokenizer+model workflows
#   • saving / re-loading checkpoints (local dir or HF Hub)
#   • optional push_to_hub
#   • quick inspection of hidden_states / logits
#
# Author: YOU
# ==========================================================
...
* inspect logits / hidden states for debugging.
